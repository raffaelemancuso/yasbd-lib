...
**SPOILER**: Yasbd aced 'em all in accuracy while offering balanced speed. On _Adventures of Sherlock Holmes_ (594k chars), yasbd is ~2-7.5× faster than pysbd (2.1s vs 15.9s warm) with far fewer false splits.
